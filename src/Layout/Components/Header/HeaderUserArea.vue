                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="widget-chart p-0">
                                        <div class="widget-chart-content">
                                            <div
                                                class="widget-numbers text-warning fsize-3"
                                            >
                                                43
                                            </div>
                                            <div class="widget-subheading pt-1">
                                                Packages
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="widget-chart p-0">
                                        <div class="widget-chart-content">
                                            <div
                                                class="widget-numbers text-danger fsize-3"
                                            >
                                                65
                                            </div>
                                            <div class="widget-subheading pt-1">
                                ...
                                <div class="col">
                                    <div class="widget-chart p-0">
                                        <div class="widget-chart-content">
                                            <div
                                                class="widget-numbers text-success fsize-3"
                                            >
                                                18
                                            </div>
                                            <div class="widget-subheading pt-1">
                                ...
                                <li class="pt-2 pb-2 pr-2 list-group-item">
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left">
                                                <div
                                                    class="widget-heading font-weight-normal"
                                                >
                                                    TPSReport.docx
                                                </div>
                                            </div>
                                            ...
                                            >
                                                <button
                                                    class="btn-icon btn-icon-only btn btn-link btn-sm"
                                                >
                                                    <font-awesome-icon
                                ...
                                <li class="list-group-item">
                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            >
                                                <button
                                                    class="border-0 btn-transition btn btn-sm btn-outline-success"
                                                >
                                                    <font-awesome-icon
                                                        icon="check"
                                                    />
                                                ...
                                                <button
                                                    class="border-0 btn-transition btn btn-sm btn-outline-danger"
                                                >
                                                    <font-awesome-icon
                                                        icon="trash-alt"
                                                    />
                    ...
                    <div class="drawer-section">
                        <div class="notifications-box">
                            ...
                            >
                                ...
                                <div>user email: {{ userData.emal }}</div>
